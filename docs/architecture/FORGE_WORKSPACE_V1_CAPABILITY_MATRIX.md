...
| New repository / Genesis | PARTIAL / V1_REQUIRED / Workspace intent + EP provision | MISSING | UI/EP/GitHub contract PARTIAL | auth, idempotency, recovery, qualification MISSING; `G003`; DOCUMENTED_NOT_IMPLEMENTED |
| Existing repository adoption | PARTIAL / V1_REQUIRED / Forge interpretation + EP attachment | PARTIAL | Workspace proposal/EP declaration PARTIAL | governance acceptance and drift recovery MISSING; `G003/G004` |
| Project Contract / baseline | MISSING / V1_REQUIRED / Forge | MISSING | all consumers MISSING | snapshot/migration/gate MISSING; `G002`; MISSING |
| Repository governance | PARTIAL / V1_REQUIRED / Forge desired, EP/provider actual | MISSING | Workspace projection PARTIAL | generic baseline, reconcile and qualification MISSING; `G004` |
...
| Effective DoR/DoD/Human Gate | PARTIAL / V1_REQUIRED / Forge composition + human | MISSING | Workspace review MISSING | identity, rejection/repair, proof lineage MISSING; `G006` |
...
| Quality learning | PARTIAL / FOUNDATION_ONLY / Forge | MISSING | Workspace view MISSING | observation/review/dedupe MISSING; `G012` |
| Knowledge learning | DEFINED boundaries / FOUNDATION_ONLY / Forge | PARTIAL | Workspace view MISSING | source lineage defined; certification unavailable MISSING; `G012` |
