...
class RuntimeEvidenceTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.database.record_mission_recommendation({"id": "recommendation-1", "architecture_review_id": "review-1", "priority": "low", "confidence": {}, "dependencies": {}, "required_disciplines": [], "recommendation_timestamp": "2026-08-04T00:00:00Z"}, mission_id="mission-1")
