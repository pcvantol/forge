...
explicit `1.2` readback and `1.4` terminal-evidence contracts, and reports project/repository and
...
[Forge 2.7.22 release/installation completion record](docs/operations/FORGE_2_7_22_RELEASE_INSTALLATION_COMPLETION.md).
